...
import type { ApiMessage, Member, PaymentMethod, SalaryEntryType, SalarySummary, SalaryPaymentRecord } from "@/lib/types";
import { money, today } from "@/lib/utils";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { useEffect, useState } from "react";
import { toast } from "sonner";

export function PayrollPanel({ businessId, member, currency }: { businessId: string | number; member: Member; currency: string }) {
  ...
  async function invalidate() {
    await Promise.all([
      ...
      queryClient.invalidateQueries({ queryKey: ["team-member", String(businessId), member.id] }),
