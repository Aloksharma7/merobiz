...
const blank = { role: "employee" as BusinessRole, full_control: false, title: "", active: true, salary_amount: "0", salary_visible_to_staff: false, ownership_percent: "0", profit_share_percent: "0" };
      ...
      <form id="member-edit-form" onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
        ...
        {actorFullControl ? (
          <div className="rounded-2xl border border-[var(--line)] p-4 sm:col-span-2">
            ...
            <p className="mt-0.5 text-xs leading-5 text-[var(--ink-soft)]">A cut of the business's overall net profit, available to anyone on the team, not just owners. Leave at 0 if this person shouldn't get a share.</p>
